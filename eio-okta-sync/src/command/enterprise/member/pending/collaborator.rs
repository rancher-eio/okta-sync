...
use crate::github::graphql::query::enterprise_pending_collaborator_invitations::Query;
use crate::graphql::{PaginateQuery, Variables};

#[derive(Debug, clap::Parser)]
#[remain::sorted]
#[rustfmt::skip]
#[command(about = "list pending collaborator invitations across the repositories in the enterprise")]
pub struct Command {
  #[arg(
    long,
    alias         = "enterprise",
