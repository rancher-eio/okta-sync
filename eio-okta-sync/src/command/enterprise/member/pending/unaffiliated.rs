...
use crate::github::graphql::query::enterprise_pending_unaffiliated_member_invitations::Query;
use crate::graphql::{PaginateQuery, Variables};

#[derive(Debug, clap::Parser)]
#[remain::sorted]
#[rustfmt::skip]
#[command(about = "list pending unaffiliated member invitations for the enterprise")]
pub struct Command {
  #[arg(
    long,
    alias         = "enterprise",
